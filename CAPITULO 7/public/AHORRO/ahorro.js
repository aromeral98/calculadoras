...
//No mostrar valor en lugar del NaN
//   const validarImporte=(msg)=>{
//     try{
    
//        if(isNaN(elementoImporte.value)) throw "fafa ";
//        if(elementoImporte.value) console.log("Mayor de edad")
...
// validarImporte()
  ...
  elementoGastos.textContent =
    ...
    (elementoImporte.value = elementoImporte.value) ? elementoIntroducido.textContent = Intl.NumberFormat("us-EN").format(introducido.toFixed(2)) + "€"
                                                    : elementoIntroducido.textContent =" 0€"
